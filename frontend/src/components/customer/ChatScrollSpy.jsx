...
const ChatScrollSpy = ({ messages, onScrollTo, onScrollTop }) => {
  ...
  return (
    <div className="fixed right-4 top-1/2 -translate-y-1/2 z-[100] hidden md:flex flex-col items-end gap-2 group/spy">
      ...
      <div className="max-h-[50vh] overflow-y-auto overflow-x-hidden no-scrollbar py-4 px-2 bg-[#0a0a0a]/60 backdrop-blur-md border border-white/5 shadow-2xl rounded-2xl flex flex-col items-center gap-3 w-[40px] hover:w-[280px] transition-all duration-300 ease-in-out group/container">
        <div className="flex flex-col gap-3 relative w-full items-center">
          ...
          {userMessages.map((msg, index) => (
            <div key={msg.id} className="relative flex items-center justify-end w-full h-4 pr-[11px] group/item">
