...
const BiometricsForm = ({ user, userId, onUpdateSuccess }) => {
  ...
  return (
    <form
      ...
      className="bg-surface-container rounded-xl p-8 lg:p-10 border border-outline-variant/15 shadow-2xl shadow-black/40"
    >
      <h3 className="text-xl font-bold mb-8 border-b border-outline-variant/15 pb-4">
        Core Biometrics
      </h3>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-8">
        ...
        <div className="flex flex-col gap-2 relative">
          <label className="text-xs uppercase tracking-[0.05em] text-on-surface-variant font-bold">
            Comms Link (Phone)
          </label>
      ...
      {/* <div className="mb-8">
        <label className="text-xs uppercase tracking-[0.05em] text-on-surface-variant font-bold block mb-4">
          Biological Anchor (Gender)
        </label>
      ...
      <div className="mb-12">
        <label className="text-xs uppercase tracking-[0.05em] text-on-surface-variant font-bold block mb-2">
