  ...
  const features = [
    {
      title: 'AI Coaching',
      description:
        'Real-time adjustments to your training based on actual performance data and biometric tracking.',
      icon: (
        <svg
    ...
    },
    {
      ...
      description:
        'Advanced motion analysis to ensure perfect form and maximum muscle recruitment for every rep.',
      icon: (
        <svg
          xmlns="http://www.w3.org/2000/svg"
          fill="none"
    ...
    },
    {
      title: 'Bio Analytics',
      description:
        'Deep dive into your recovery, strength gains, and physiological evolution with visual data.',
      icon: (
        <svg
          xmlns="http://www.w3.org/2000/svg"
          fill="none"
