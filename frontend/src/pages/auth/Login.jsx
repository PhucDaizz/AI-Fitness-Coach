  ...
  return (
    <div className="bg-background text-on-surface font-body selection:bg-primary selection:text-on-primary min-h-screen flex flex-col items-center justify-center relative overflow-hidden">
      ...
      <div className="absolute top-8 left-8 z-20">
        <Link to="/" className="flex items-center gap-2 text-on-surface-variant hover:text-primary transition-colors font-bold uppercase tracking-widest text-xs">
      ...
      <main className="w-full max-w-md px-6 py-12 relative z-10">
        ...
        <div className="mb-12 text-center">
          ...
          <p className="text-on-surface-variant text-sm mt-2 font-black tracking-wide uppercase">Performance Intelligence Dashboard</p>
        </div>
        ...
        <div className="mt-20 flex justify-center gap-8 opacity-40">
          <a className="text-[0.625rem] font-bold uppercase tracking-widest hover:text-white transition-colors" href="#">Privacy Policy</a>
          <a className="text-[0.625rem] font-bold uppercase tracking-widest hover:text-white transition-colors" href="#">Terms of Service</a>
        </div>
      </main>
    </div>
  );
